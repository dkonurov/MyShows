...
public class Parser {
    ...
    private User parseUser(String json) {
        ...
        Bitmap bitmap = ImageLoader.getInstance().loadImageSync(user.getAvatarUrl());
        return user;
    }
    ...
    private List<Episode> parseMassiveSeries(String json) {
        Gson gson = new Gson();
    ...
    public Object parseMethod(EnumMethod enumMethod, String json) {
        switch (enumMethod) {
            ...
            case CURRENT_SHOW:
                return parseMassiveSeries(json);
            default:
                return null;
        }
    }
